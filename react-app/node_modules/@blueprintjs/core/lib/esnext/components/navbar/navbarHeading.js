...
let NavbarHeading = class NavbarHeading extends AbstractPureComponent2 {
    render() {
        const { children, className, ...htmlProps } = this.props;
        return (React.createElement("div", Object.assign({ className: classNames(Classes.NAVBAR_HEADING, className) }, htmlProps), children));
    }
};
