...
let TagInput = class TagInput extends AbstractPureComponent2 {
    constructor() {
        ...
        this.maybeRenderTag = (tag, index) => {
            ...
            return (React.createElement(Tag, Object.assign({ active: index === this.state.activeIndex, "data-tag-index": index, key: tag + "__" + index, large: large, onRemove: this.props.disabled ? null : this.handleRemoveTag }, props), tag));
        };
