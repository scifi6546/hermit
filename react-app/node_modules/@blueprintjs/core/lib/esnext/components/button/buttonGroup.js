...
let ButtonGroup = class ButtonGroup extends AbstractPureComponent2 {
    render() {
        ...
        return (React.createElement("div", Object.assign({}, htmlProps, { className: buttonGroupClasses }), this.props.children));
    }
};
