...
import { AbstractPureComponent2, Alignment, IActionProps, MaybeElement } from "../../common";
...
export declare abstract class AbstractButton<H extends React.HTMLAttributes<any>> extends AbstractPureComponent2<IButtonProps & H, IButtonState> {
    state: {
        isActive: boolean;
    };
