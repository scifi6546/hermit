...
var TagInput = /** @class */ (function (_super) {
    ...
    function TagInput() {
        ...
        _this.refHandlers = {
            input: function (ref) {
                ...
                common_1.Utils.safeInvoke(_this.props.inputRef, ref);
            },
        };
        _this.addTags = function (value, method) {
            ...
            var shouldClearInput = common_1.Utils.safeInvoke(onAdd, newValues, method) !== false && inputValue === undefined;
        ...
        _this.handleInputFocus = function (event) {
            ...
            common_1.Utils.safeInvoke(_this.props.inputProps.onFocus, event);
        };
        _this.handleInputChange = function (event) {
            _this.setState({ activeIndex: NONE, inputValue: event.currentTarget.value });
            common_1.Utils.safeInvoke(_this.props.onInputChange, event);
            common_1.Utils.safeInvoke(_this.props.inputProps.onChange, event);
        };
    ...
    TagInput.prototype.render = function () {
        ...
        return (React.createElement("div", { className: classes, onBlur: this.handleContainerBlur, onClick: this.handleContainerClick },
            React.createElement(icon_1.Icon, { className: common_1.Classes.TAG_INPUT_ICON, icon: leftIcon, iconSize: isLarge ? icon_1.Icon.SIZE_LARGE : icon_1.Icon.SIZE_STANDARD }),
            React.createElement("div", { className: common_1.Classes.TAG_INPUT_VALUES },
                values.map(this.maybeRenderTag),
                this.props.children,
                React.createElement("input", tslib_1.__assign({ value: this.state.inputValue }, inputProps, { onFocus: this.handleInputFocus, onChange: this.handleInputChange, onKeyDown: this.handleInputKeyDown, onKeyUp: this.handleInputKeyUp, onPaste: this.handleInputPaste, placeholder: resolvedPlaceholder, ref: this.refHandlers.input, className: classnames_1.default(common_1.Classes.INPUT_GHOST, inputProps.className), disabled: disabled }))),
    ...
    TagInput.prototype.removeIndexFromValues = function (index) {
        ...
        common_1.Utils.safeInvoke(onRemove, values[index], index);
        if (common_1.Utils.isFunction(onChange)) {
    ...
    TagInput.prototype.invokeKeyPressCallback = function (propCallbackName, event, activeIndex) {
        common_1.Utils.safeInvoke(this.props[propCallbackName], event, activeIndex === NONE ? undefined : activeIndex);
        common_1.Utils.safeInvoke(this.props.inputProps[propCallbackName], event);
    };
