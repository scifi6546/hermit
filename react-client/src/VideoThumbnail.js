...
import { Segment, Image, Rating, Dropdown, Button, Form, Input } from 'semantic-ui-react'
...
class VideoThumbnail extends React.Component {
    ...
    async confirmUpdate() {
        ...
        this.state.updateVideo(this.state.url, this.state.description, this.state.starRating,
            this.state.rating, this.state.path, this.state.name);
                ...
                <Segment.Group horizontal>
                    <Segment>
                        <Form>
                            ...
                            {this.state.nameEditInv.map((foo) =>
                                <div onClick={this.editName}>
                                    {this.state.name}
                                </div>
                            )}
                            {this.state.nameEdit.map((foo) =>
                                <Input onChange={this.updateName} defaultValue={this.state.name} />
                            )}
